        ...
        <div className="nav__wrapper">
          ...
          <ul className="nav__list--wrapper">
            <li
              ...
              onClick={user ? logout : () => openAuthModal("login")}
            >
              {user ? "Logout" : "Login"}
            </li>
          ...
          <div className="row">
            <div className="landing__wrapper">
              ...
              <figure className="landing__image--mask">
                <img src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?q=80&w=1200&auto=format&fit=crop" alt="landing" />
              </figure>
            </div>
          </div>
        </div>
